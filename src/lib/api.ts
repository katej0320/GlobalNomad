...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjU0MDQ5MiwiZXhwIjoxNzQyNTQyMjkyLCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.SNENXjTD45sKGvuqsajJLLCk1WHy3p4922klZ2KKiiQ`, // << 하드코딩으로 데이터 확인할 때
