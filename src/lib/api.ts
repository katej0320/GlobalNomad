...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjAyODcwOCwiZXhwIjoxNzQyMDMwNTA4LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.s5uRCmS466aYYckzIg6_HUtkwMX-8B_A_Y480CPaGXY`, //하드코딩으로 데이터 확인할 때
