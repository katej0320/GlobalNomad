...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0Mjk3MTAxMiwiZXhwIjoxNzQyOTcyODEyLCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.QRqE7QVgZSaxUDSWUrv-KnX8pvrQo62DMvo8aCY1hHA`, // << 하드코딩으로 데이터 확인할 때
