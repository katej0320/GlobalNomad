...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjI4ODY2NywiZXhwIjoxNzQyMjkwNDY3LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.wn4tFuMJD_W3Lfg9ly-C3Ydj3m2fXE6RuopmaKPsdqM`, // << 하드코딩으로 데이터 확인할 때
