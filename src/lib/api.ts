...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0Mjg4NTk2NSwiZXhwIjoxNzQyODg3NzY1LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.iQ8wVpCmUUdzC3l_jZkPy2zQtPNd9Pl_MJYIkJK_bno`, // << 하드코딩으로 데이터 확인할 때
