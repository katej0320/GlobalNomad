...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjAzODI4NSwiZXhwIjoxNzQyMDQwMDg1LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.yrLLnccQ0T9Sb4A97EKb247HeY8b4A9SuBKukZaG_98`, //하드코딩으로 데이터 확인할 때
