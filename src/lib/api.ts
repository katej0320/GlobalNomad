...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjAzMDUzOSwiZXhwIjoxNzQyMDMyMzM5LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.HcXVDsHmQfxZS8isPRLxoiyiLKA_Uvqtdi4kappMENY`, //하드코딩으로 데이터 확인할 때
