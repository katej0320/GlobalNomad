...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjU0NDY5OCwiZXhwIjoxNzQyNTQ2NDk4LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.EOxXVlfc6TJ9r0ho8fWH8z4LBJ933gu7cjK3eh7-fYM`, // << 하드코딩으로 데이터 확인할 때
