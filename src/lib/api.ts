...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjgyNDYyMSwiZXhwIjoxNzQyODI2NDIxLCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.DV0XCkzLc9zxlr3WXeaSljJviJ1KsirGX99OApaEXyo`, // << 하드코딩으로 데이터 확인할 때
