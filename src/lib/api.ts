...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc1NiwidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjYyOTAwNywiZXhwIjoxNzQyNjMwODA3LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.EEMo5LL3R2hKsr9n7944INls9KDB1qYW4jCi7eO8_-s`, // << 하드코딩으로 데이터 확인할 때
