...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc3MiwidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjQ2MTUwOSwiZXhwIjoxNzQzNjcxMTA5LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.yrwWmiqjOdomRWU-Cdlw1-mSVqVdrzucL4AMIlgefs4`, // << 하드코딩으로 데이터 확인할 때
