...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0MjE4NTI4MSwiZXhwIjoxNzQyMTg3MDgxLCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.N2f6K0ITB0YbPcWZqEYVZVnX2xSlSG-6uPRayjAMALw`, // << 하드코딩으로 데이터 확인할 때
