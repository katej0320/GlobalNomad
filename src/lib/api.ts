...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0Mjk2NjA4OSwiZXhwIjoxNzQyOTY3ODg5LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.-1V4ENaU-34WB06Oe-i0u5e3yLgZvlsM-NVABBWffgw`, // << 하드코딩으로 데이터 확인할 때
