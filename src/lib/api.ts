...
const instance: AxiosInstance = axios.create({
  baseURL: BASE_URL,
  headers: {
    Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTc0MywidGVhbUlkIjoiMTItMiIsImlhdCI6MTc0Mjk3MjY1OSwiZXhwIjoxNzQyOTc0NDU5LCJpc3MiOiJzcC1nbG9iYWxub21hZCJ9.HVywIeFbqmvd4NtfspKOvQl0EQpa7DuibOH_hNHQu0M`, // << 하드코딩으로 데이터 확인할 때
